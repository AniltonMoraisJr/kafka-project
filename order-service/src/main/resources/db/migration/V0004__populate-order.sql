-- CustomerOrders
INSERT INTO CustomerOrder (id, orderDateTime, status, customerName, customerCpf, customerPhone, customerAddress)
VALUES
...
INSERT INTO CustomerOrder_SEQ (next_val) VALUES (16);

-- Itens dos CustomerOrders
-- CustomerOrder do Chaves
INSERT INTO CustomerOrderItem (id, amount, unitPrice, observation, customerOrder_id, menuItem_id)
VALUES
(1, 1, 3.50, 'Com bastante presunto, por favor!', 1, 1), -- Sanduíche de Presunto do Chaves
(2, 2, 2.99, 'Bem gelado', 1, 2); -- Refresco

-- CustomerOrder do Seu Madruga
INSERT INTO CustomerOrderItem (id, amount, unitPrice, observation, customerOrder_id, menuItem_id)
VALUES
(3, 1, 5.99, 'Pode ser bem queimadinho!', 2, 3), -- Tostadas do Seu Madruga
(4, 1, 1.99, NULL, 2, 8); -- Café da Dona Florinda

-- CustomerOrder da Seu Madroga, Primo do Seu Madruga'
INSERT INTO CustomerOrderItem (id, amount, unitPrice, observation, customerOrder_id, menuItem_id)
VALUES
...
-- Itens dos CustomerOrders
-- CustomerOrder da Dona Clotilde
INSERT INTO CustomerOrderItem (id, amount, unitPrice, observation, customerOrder_id, menuItem_id)
VALUES
